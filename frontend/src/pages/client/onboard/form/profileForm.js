...
export default function Upload({ onNext, onStoreData }) {
    ...
    return (
        <>
            <Stack spacing={5}>
                <Typography variant="body1" sx={{ mt: 3, fontWeight: 'bold' }}>Company Logo & Permits</Typography>
                <Typography variant="body2" sx={{ mb: 0, fontWeight: 'bold', textAlign: 'center' }}>Please upload a professional portrait that clearly shows your face</Typography>
                ...
                <Typography variant="body2" sx={{ mb: 0, fontWeight: 'bold', textAlign: 'center', mt: 10 }}>Please upload a document to indicate your business</Typography>
