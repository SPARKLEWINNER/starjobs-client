        ...
        <div>
            <Dialog open={open} >
                <DialogTitle sx={{ textAlign: 'center', pt: 5 }} >
                    <Typography variant="h6" sx={{ fontWeight: 'normal' }}>Confirm End-Shift</Typography>
                </DialogTitle>
                <DialogActions sx={{ display: 'block', pb: 5, px: 5 }}>
                    <Typography variant="body1" sx={{ mb: 3 }}>Please ensure that all the assigned tasks have been successfully carried out. Take note of your
                        personal belongings before you leave. If successful, update “end-shift?</Typography>
                    <Stack row>
