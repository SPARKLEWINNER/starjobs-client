...
const forgotPassword = (token) => {
  return (
                          ...
                          <div style="height: 100%;width: 100% !important;">
                            ...
                            <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                              ...
                              <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                <tbody>
                                  <tr>
                                    <td style="overflow-wrap:word-break:break-word;padding:0px 10px 0px;font-family:'Cabin',sans-serif;" align="left">
        
                                      <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                                        <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 30px; line-height: 42px;"><strong><span style="line-height: 42px; color: #000000; font-family: 'Open Sans', sans-serif;"><span style="line-height: 42px;">FORGOT PASSWORD</span></span>
                                          </strong>
                                          </span>
                                        </p>
                                      </div>
                                  ...
                                  <tr>
                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                      ...
                                      <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                        <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px; font-family: 'Open Sans', sans-serif;">Reset password request has been received, click the button below to change your password.</span></p>
                                        <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px; font-family: 'Open Sans', sans-serif;">If you did not request this, please ignore this email and your password will remain unchanged.</span></p>
                                      </div>
    ...
    token +
    `" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #0061bf; border-radius: 25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-family: 'Open Sans',sans-serif; font-size: 25px;font-weight: 400; ">
                                          <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span style="line-height: 33.6px;"><span style="line-height: 33.6px;">RESET PASSWORD</span></span>
                                          </span>
                                        </a>
                                        </center></v:roundrect>
                                      </div>
