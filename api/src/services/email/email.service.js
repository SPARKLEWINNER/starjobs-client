...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'starjobshelp@gmail.com', // your Gmail address
...
var controller = {
  send_mail: async function (data) {
    ...
    switch (data.type) {
      case 'sign_up':
        mailOptions = {
          from: `Starjobs <starjobshelp@gmail.com>`,
          to: data.email,
          subject: 'Verification code - Starjobs',
          html: signUp(data.verifyCode)
        }
        break
      ...
      case 'forgot_password':
        mailOptions = {
          from: `Starjobs <starjobshelp@gmail.com>`,
          to: data.email,
          subject: 'Forgot password Request - Starjobs',
          html: forgotPassword(data.token.resetToken)
        }
        break
      ...
      case 'request_history': {
        ...
        mailOptions = {
          from: `Starjobs <starjobshelp@gmail.com>`,
          to: email,
          subject: 'Request History Report - Starjobs',
          html: `
          <div style="font-family:Arial,sans-serif;">
            <h2>📄 Request History Report</h2>
            <p>Hi there,</p>
            <p>Please find your request history attached as a CSV file. You can open it using Excel, Google Sheets, or any spreadsheet software.</p>
            <p>If you didn’t request this, please ignore this email.</p>
            <p>Thanks,<br><strong>Starjobs Team</strong></p>
          </div>
        `,
          attachments: [
            {
              filename: 'request-history.csv',
      ...
      default:
        mailOptions = {
          from: `Sparkle Account Change Password <starjobshelp@gmail.com>`,
          to: `emquintos.developer@gmail.com`,
          subject: 'Change Password Request',
          html: `<p>You are receiving this because you have successfully changed your password for your account.<br><br>Have a Sparkling day.</p>`
        }
        break
    }
    ...
    try {
      ...
      await logger.logError(error, 'MAILER.send_mail.GMAIL', data, null, 'POST')
      return false
    }
  }
