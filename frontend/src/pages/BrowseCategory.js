                    ...
                    {isLoading ?
                        <Box sx={{ minHeight: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Box spacing={2} sx={{ mb: 10 }}>
                                {category.dynamic && category.dynamic.map((v, k) => {
                                    return v.status === 1 ?
                                        <Box underline="none" key={k} sx={{ display: 'inline-block', width: '43%', m: 1, textAlign: 'center', verticalAlign: { xs: 'top' } }} color="#000">
                                            <Box
                                                component="img"
                                        ...
                                        :
                                        <Box underline="none" key={k} sx={{ display: 'inline-block', width: '43%', m: 1, textAlign: 'center', verticalAlign: { xs: 'top' } }} color="#000">
                                            <Link underline="none" key={k} component={RouterLink} to={v.status === 1 ? `#` : `/gigs/${v.slug}`} sx={{ textAlign: 'center' }} color="#000">
                                                <Box
                                                    component="img"
                                                    src={v.image}
                                                    sx={{ height: { sm: 150, xs: 100 }, mx: 'auto', my: { xs: 0, sm: 2 } }}
