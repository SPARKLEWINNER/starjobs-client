    ...
    return (
        <FormikProvider value={formik}>
            <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                <Typography variant="body1" sx={{ mb: 3, mt: 3, fontWeight: 'bold' }}>Education Background</Typography>
                <Stack spacing={3}>
                    <Box>
                    ...
                    <Box>
                        ...
                        <Stack sx={{ mt: 3 }} direction={{ xs: 'column', sm: 'column' }} spacing={2}>
                            ...
                            <Typography variant="body2" sx={{ fontWeight: 'bold' }}>Program / Course</Typography>
                            <Select native {...getFieldProps('vocationalProgramCourse')} value={values.civilStatus}>
                                <option selected value="" key="initialProgramCourse" disabled>Select Program / Course</option>
